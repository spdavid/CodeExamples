...
export default class SiteOrderFormWebPart extends BaseClientSideWebPart<ISiteOrderFormWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISiteOrderFormProps> = React.createElement(
      SiteOrderForm,
      {
